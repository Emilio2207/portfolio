  ...
  return (
    <div className='navbar'>
      ...
      <ul ref={menuRef} className="nav-menu">
        ...
        <li><AnchorLink className='anchor-link' offset={50} href='#about'><p onClick={()=>setMenu("about")}>Sobre mi</p></AnchorLink>{menu === "about" ? <img src={underline} alt='' /> : <></>}</li>
      ...
      <div className='nav-connect'><AnchorLink className='anchor-link' offset={50} href='#contact'>Contactate conmigo</AnchorLink></div>
    </div>
  );
};
